...
public class CarSystem {
    ...
    public static void menu() throws Exception {
        ...
        System.out.println("5. 單筆查詢 Driver");
        System.out.println("6. 單筆查詢 Cars");
        System.out.println("7. 買車 Buy");
        System.out.println("8. 賣車(過戶) Sell");
        ...
        switch (sc.next()) {
            case "1":
                System.out.println("請輸入Driver名稱: ");
                addDriver(sc.next());
                break;
            case "2":
            ...
            case "4":
                ...
                break;
            case "5":
                System.out.println("請輸入要查詢的Driver名稱: ");
                ...
                break;
            case "6":
                System.out.println("請輸入要查詢的Car名稱: ");
    ...
    public static void queryDrivers() throws Exception {
        em.clear();
        List<Driver> list = em.createQuery("SELECT d FROM Driver d").getResultList();
        print(list);
    }

    public static void queryCars() throws Exception {
        em.clear();
        List<Car> list = em.createQuery("SELECT d FROM Car d").getResultList();
        print(list);
    }
    ...
    public static Object getCar(String name) {
        ...
        //em.find 只能用id查詢
        Query q = em.createQuery("SELECT d FROM Car d WHERE d.name =:name");
        q.setParameter("name", name);
        int size = q.getResultList().size();
        if (size == 0) {
